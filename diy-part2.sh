...
# 修复设备配置问题，确保生成 ASUS RT-AC42U 固件
# =============================================

echo "开始执行 DIY 脚本第二部分..."

# ==================== 设备配置修复 ====================
echo "修复设备配置，确保生成 ASUS RT-AC42U 固件..."
...
# 添加正确的设备配置 - ASUS RT-AC42U
echo "添加正确的 ASUS RT-AC42U 配置..."
cat >> .config << 'EOF'
# ==================== 设备配置修复 ====================
# 确保生成 ASUS RT-AC42U 固件
...
echo "✅ ASUS RT-AC42U 设备配置已设置"

# ==================== 验证设备配置 ====================
echo "验证设备配置..."
if grep -q "CONFIG_TARGET_DEVICE_ipq40xx_generic_DEVICE_asus_rt-ac42u=y" .config; then
    echo "✅ ASUS RT-AC42U 设备配置确认正确"
else
